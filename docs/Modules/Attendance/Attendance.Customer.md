# Attendance Guide
    ...
    Attendance days, punch flows, correction requests, admin correction listing, and the leave-aware effective attendance model.
...
- Review related workflow or setup prerequisites before starting operational use.
    ...
    ## 5. How to use it
    - Use the main Attendance workflow from the verified route set: /attendance/days, /attendance/punch, /attendance/corrections, /attendance/corrections/new.
...
- Some admin and manager views need additional screenshots or verified customer wording.
    ...
    - Primary engineering reference: `docs/Modules/Attendance/Attendance.Internal.md`
