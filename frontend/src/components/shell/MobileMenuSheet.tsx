  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="left"
        className={cn(
          "border-r border-white/10 bg-white/[0.04] backdrop-blur-xl",
          "text-foreground"
        )}
      >
        <SheetHeader className="gap-2">
          <SheetTitle className="text-base tracking-tight">Menu</SheetTitle>
          <div className="text-xs text-muted-foreground">
            Switch modules and navigate.
          </div>
        </SheetHeader>
              ...
              return (
                <SheetClose key={m.id} asChild>
                  <Button
                    ...
                    variant="ghost"
                    className={cn(
                      "h-auto items-start justify-start gap-2 rounded-2xl border border-white/10 bg-white/[0.03] px-3 py-2 text-left",
                      "hover:bg-white/[0.06]",
                      active &&
                  ...
                  >
                    <Link href={m.href} aria-label={`Go to ${m.label}`}>
              ...
              return (
                <SheetClose key={item.id} asChild>
                  <Button
                    ...
                    variant="ghost"
                    className={cn(
                      "h-auto w-full justify-start gap-3 rounded-2xl px-3 py-2 text-left",
                      "hover:bg-white/[0.06]",
                      active &&
